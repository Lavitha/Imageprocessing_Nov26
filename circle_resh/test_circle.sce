...
aa=circle(aaa,100, 200, 50, 10, 10, 10, 1, 0, 0)
bb=circle(bbb, 100, 200, 50, 10, 10, 10, 8, 0, 0)
cc=circle(ccc, 100, 200, 50, 10, 10, 10, 4, 0, 0)
dd=circle(ddd, 100, 200, 50, 10, 10, 10, 6, 0, 0)
ee=circle(eee, 100, 200, 50, 10, 10, 10, , 0, 0)
